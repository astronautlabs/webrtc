...
async function measureTimeFromRTCVideoSourceToRTCVideoSink(source: RTCVideoSource, sink: RTCVideoSink, width: number, height: number, n?: number) {
...
async function measureTimeFromRTCVideoSourceToLocalRTCVideoSink(width: number, height: number, n?: number) {
...
async function measureTimeFromRTCVideoSourceToRemoteRTCVideoSink(width: number, height: number, n?: number) {
    const source = new RTCVideoSource();
...
function testTimeFromRTCVideoSourceToLocalVideoSink(width: number, height: number) {
...
function testTimeFromRTCVideoSourceToRemoteVideoSink(width: number, height: number) {
...
async function measureTimeThroughRTCDataChannel(localDataChannel: RTCDataChannel, remoteDataChannel: RTCDataChannel, n?: number) {
    n = typeof n === 'number' ? n : 300;
